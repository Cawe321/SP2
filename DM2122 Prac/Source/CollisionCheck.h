...
public:
	...
	static bool NonCharacterCollisionCheck(Vector3 obj1, float obj1SizeX, float obj1SizeZ); // this is the actual collision check for the map | true = no collision detected
