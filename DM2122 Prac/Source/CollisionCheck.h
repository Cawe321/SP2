...
public:
	...
	static bool TrueCollisionCheck(Vector3 obj1, float obj1SizeX, float obj1SizeZ, Vector3 obj2, float obj2SizeX, float obj2SizeZ); // this is the actual collision check for the map
